...
//@ComponentScan(basePackages = "com.revomatico.internship2019.demo1")
public class ClientSpringBootApp {
  ...
  private void initDb() {
    ...
    jdbcTemplate.query("select id,NAME,DATE from test", new RowMapper<Object>() {
      @Override
      public Object mapRow(ResultSet rs, int i) throws SQLException {
        System.out.println(String.format("id:%s,NAME:%s,DATE:%s", rs.getString("id"), rs.getString("NAME"), rs.getString("DATE")));
        return null;
      }
    });
  }
